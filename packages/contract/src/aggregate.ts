/* The aggregations behind /api/mapping/* and /api/tickets/summary, shared by
   the API and the mock API so the two cannot disagree (AD-8). Logic follows
   the wireframe's confidenceBlock, reviewTable and screenTickets. */
